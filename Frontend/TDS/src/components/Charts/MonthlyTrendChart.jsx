...
export default function MonthlyTrendChart() {
  return (
    <ResponsiveContainer width="100%" height={200}>
      <AreaChart data={monthlyTrend} margin={{ top: 2, right: 4, left: -20, bottom: 0 }}>
        <defs>
        ...
        <Area type="monotone" dataKey="issues" stroke="#991B1B" strokeWidth={2} fill="url(#issueGrad)" dot={false} name="Issues" />
